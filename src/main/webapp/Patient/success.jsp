...
<head>
    <meta charset="UTF-8">
    <title>MediCare | Registration Success</title>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="success-card">
            ...
            <h1>All Set!</h1>
            <p>The patient record has been secured and stored in the hospital database.</p>

            <div class="btn-group-custom">
                <a href="<%= request.getContextPath() %>/Patient/register.jsp" class="btn-primary-custom">
                    <i class="bi bi-person-plus-fill me-2"></i> Register Another Patient
                </a>
                <a href="<%= request.getContextPath() %>/Patient/viewPatients.jsp" class="btn-outline-custom">
                    <i class="bi bi-list-ul me-2"></i> Go to Patient Directory
                </a>
