...
<head>
    <meta charset="UTF-8">
    <title>MediCare | View All Doctors</title>
...
<div class="container py-5">
    ...
    <div class="row align-items-center mb-4 no-print">
        <div class="col-md-6">
            <h2 class="fw-bold mb-1 text-dark">Doctor Directory</h2>
            <p class="text-muted small">Manage and monitor all doctors registered in the hospital.</p>
        </div>
        <div class="col-md-6 text-md-end">
            ...
            <a href="<%= request.getContextPath() %>/Doctor/registerDoc.jsp" class="btn btn-primary rounded-pill px-4 shadow-sm">
    ...
    <div class="card main-card">
        <div class="table-responsive">
            <table class="table align-middle mb-0" id="doctorTable">
                <thead>
                    <tr>
                        <th class="ps-4">Doctor / Identity</th>
                        <th>Contact</th>
                        <th>Professional Info</th>
                        <th>Experience / Department</th>
                    ...
                    <tr class="doctor-row">
                        <td class="ps-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <span class="doctor-name"><%= fName %> <%= lName %></span>
                                    <span class="info-label"><%= rs.getString("gender") %></span>
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="data-value d-block"><i class="bi bi-telephone me-1"></i><%= rs.getString("phone") %></span>
                            <span class="data-value d-block"><i class="bi bi-envelope me-1"></i><%= rs.getString("email") %></span>
                        </td>
                        <td>
                            <span class="badge bg-light text-dark border mb-1"><%= rs.getString("specialization") %></span>
                            <span class="info-label">Qualification: <%= rs.getString("qualification") %></span>
                        </td>
                        <td>
                            <div class="data-value"><b>Exp:</b> <%= rs.getInt("experience") %> Years</div>
                            <div class="data-value"><b>Dept:</b> <%= rs.getString("department") %></div>
                        </td>
                        <td>
                            <div class="data-value"><b>Joining:</b> <%= rs.getDate("joining_date") %></div>
                            <div class="salary">₹<%= String.format("%.2f", rs.getDouble("salary")) %></div>
                        </td>
...
<script>
    document.getElementById('searchInput').addEventListener('keyup', function() {
        ...
        let rows = document.querySelectorAll('#doctorTable tbody tr.doctor-row');
