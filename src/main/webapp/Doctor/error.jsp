...
<head>
    <meta charset="UTF-8">
    <title>MediCare | Doctor Registration Failed</title>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="error-card">
            ...
            <p>Something went wrong while processing the doctor record. Please check the information and try again.</p>

            <div class="btn-group-custom">
                <a href="<%= request.getContextPath() %>/Doctor/registerDoc.jsp" class="btn-error-custom">
